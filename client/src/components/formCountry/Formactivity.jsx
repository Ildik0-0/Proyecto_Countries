          ...
          <div className={style.formBox}>
              ...
              <form name="formTag" onSubmit={handleSubmit}>
                  ...
                  <div className={style.form}>
                        <label>Season: </label>
                        <br />
                        <select name='season' className={style.custom} onChange={handleChange} value={userData?.season} multiple={false}>
                  ...
                  <div className={style.form}>
                    ...
                    <br />
                        <div className={style.form}>
                          ...
                          <select name='difficulty' className={style.custom} onChange={handleChange} value={userData?.difficulty} multiple={false}>
                      ...
                      <div className={style.form}>
                        <label>Country: </label>
                            ...
                            <div className={style.btnCountries}>
                              {
                                userData && userData.countries && userData?.countries.map( country => (
